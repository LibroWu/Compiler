...
;True block in printTree selectCount 0
5:
	br label %42
...
define void @_global_var_init.2(){
	%1 = shl i32 1, 31
	%2 = xor i32 -1, %1
	store i32 %2, i32* @MaxRandInt, align 4
	ret void
}
...
define i32 @randInt31(){
	...
	%30 = load i32, i32* @seed, align 4
	store i32 %29, i32* @seed, align 4
...
;Converge block in generateOperations selectCount 0
25:
	br label %26
...
;loop exit block generateOperations loopDepth 1 iterCount 0
29:
	br label %30
