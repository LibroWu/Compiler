...
;loop check block gcd loopDepth 1 iterCount 0
69:
	%70 = load i32, i32* %66, align 4
	%71 = icmp sle i32 %70, 10
	br i1 %71, label %72, label %137

;loop body gcd loopDepth 1 iterCount 0
72:
	...
	store i32 %132, i32* %67, align 4
	br label %134

;loop increase block gcd loopDepth 1 iterCount 0
134:
...
;loop exit block gcd loopDepth 1 iterCount 0
137:
...
;True block in gcd selectCount 0
142:
	%143 = load i32, i32* %35, align 4
	store i32 %143, i32* %33, align 4
	br label %181

;False block in gcd selectCount 0
144:
	...
	%150 = call i32 @gcd(i32 10, i32 68, i32 0, i32 2, i32 4, i32 6, i32 8, i32 10, i32 12, i32 14, i32 16, i32 18, i32 20, i32 22, i32 24, i32 26, i32 28, i32 30, i32 32, i32 34, i32 36, i32 38, i32 40, i32 42, i32 44, i32 46, i32 48, i32 50, i32 52, i32 54, i32 56, i32 58)
	...
	%170 = load i32, i32* %57, align 4
	%171 = load i32, i32* %58, align 4
	%172 = load i32, i32* %59, align 4
	%173 = load i32, i32* %60, align 4
	%174 = load i32, i32* %61, align 4
	%175 = load i32, i32* %62, align 4
	%176 = load i32, i32* %63, align 4
	%177 = load i32, i32* %64, align 4
	%178 = load i32, i32* %65, align 4
	%179 = call i32 @gcd1(i32 %145, i32 %148, i32 %149, i32 %150, i32 %151, i32 %152, i32 %153, i32 %154, i32 %155, i32 %156, i32 %157, i32 %158, i32 %159, i32 %160, i32 %161, i32 %162, i32 %163, i32 %164, i32 %165, i32 %166, i32 %167, i32 %168, i32 %169, i32 %170, i32 %171, i32 %172, i32 %173, i32 %174, i32 %175, i32 %176, i32 %177, i32 %178)
	store i32 %179, i32* %33, align 4
	br label %181

;Converge block in gcd selectCount 0
180:
	store i32 0, i32* %33, align 4
	br label %181
...
define i32 @gcd1(i32 %0,i32 %1,i32 %2,i32 %3,i32 %4,i32 %5,i32 %6,i32 %7,i32 %8,i32 %9,i32 %10,i32 %11,i32 %12,i32 %13,i32 %14,i32 %15,i32 %16,i32 %17,i32 %18,i32 %19,i32 %20,i32 %21,i32 %22,i32 %23,i32 %24,i32 %25,i32 %26,i32 %27,i32 %28,i32 %29,i32 %30,i32 %31){
	...
	%117 = add i32 %115, %116
	%118 = load i32, i32* %62, align 4
	%119 = add i32 %117, %118
	%120 = load i32, i32* %63, align 4
	%121 = add i32 %119, %120
	%122 = load i32, i32* %64, align 4
	%123 = add i32 %121, %122
	%124 = load i32, i32* %65, align 4
	%125 = add i32 %123, %124
	%126 = srem i32 %125, 100
	%127 = load i32, i32* %66, align 4
...
;True block in gcd1 selectCount 0
132:
	%133 = load i32, i32* %35, align 4
	store i32 %133, i32* %33, align 4
	br label %171

;False block in gcd1 selectCount 0
134:
	...
	%160 = load i32, i32* %57, align 4
	%161 = load i32, i32* %58, align 4
	%162 = load i32, i32* %59, align 4
	%163 = load i32, i32* %60, align 4
	%164 = load i32, i32* %61, align 4
	%165 = load i32, i32* %62, align 4
	%166 = load i32, i32* %63, align 4
	%167 = load i32, i32* %64, align 4
	%168 = load i32, i32* %65, align 4
	%169 = call i32 @gcd2(i32 %135, i32 %138, i32 %139, i32 %140, i32 %141, i32 %142, i32 %143, i32 %144, i32 %145, i32 %146, i32 %147, i32 %148, i32 %149, i32 %150, i32 %151, i32 %152, i32 %153, i32 %154, i32 %155, i32 %156, i32 %157, i32 %158, i32 %159, i32 %160, i32 %161, i32 %162, i32 %163, i32 %164, i32 %165, i32 %166, i32 %167, i32 %168)
	store i32 %169, i32* %33, align 4
	br label %171

;Converge block in gcd1 selectCount 0
170:
	store i32 0, i32* %33, align 4
	br label %171
...
;True block in gcd2 selectCount 0
132:
	%133 = load i32, i32* %35, align 4
	store i32 %133, i32* %33, align 4
	br label %171

;False block in gcd2 selectCount 0
134:
	%135 = load i32, i32* %35, align 4
	%136 = load i32, i32* %34, align 4
	%137 = load i32, i32* %35, align 4
	...
	%167 = load i32, i32* %64, align 4
	%168 = load i32, i32* %65, align 4
	%169 = call i32 @gcd(i32 %135, i32 %138, i32 %139, i32 %140, i32 %141, i32 %142, i32 %143, i32 %144, i32 %145, i32 %146, i32 %147, i32 %148, i32 %149, i32 %150, i32 %151, i32 %152, i32 %153, i32 %154, i32 %155, i32 %156, i32 %157, i32 %158, i32 %159, i32 %160, i32 %161, i32 %162, i32 %163, i32 %164, i32 %165, i32 %166, i32 %167, i32 %168)
	store i32 %169, i32* %33, align 4
	br label %171

;Converge block in gcd2 selectCount 0
170:
	store i32 0, i32* %33, align 4
	br label %171
